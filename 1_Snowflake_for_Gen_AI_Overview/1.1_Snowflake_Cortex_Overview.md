[< Domain 1](./README.md) | **📘 1.1 Snowflake Cortex Overview** | [1.2 Gen AI Ecosystem >](./1.2_Gen_AI_Ecosystem_Integration.md)
***
...
**Next Steps**: Continue to [1.2 Gen AI Ecosystem Integration](./1.2_Gen_AI_Ecosystem_Integration.md) to learn how Snowflake Cortex integrates with the broader AI ecosystem.
